    ...
    public static ArrayList<Post> raport1() {
        try {
            ...
            if (rs.next()) {
                ...
                alert.setContentText("W bazie danych nie znaleziono danych.");
                alert.showAndWait();
                System.out.println("W bazie danych nie znaleziono danych.");
                return null;
            ...
            alert.setTitle("Błąd");
            alert.setHeaderText(null);
            alert.setContentText("Problem z pobraniem danych z bazy danych. " + ex.getLocalizedMessage());
            alert.showAndWait();
            System.out.println("Problem z pobraniem danych z bazy danych. " + ex.getLocalizedMessage());
        }
        return null;
    }
